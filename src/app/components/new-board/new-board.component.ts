...
import {AddGraphs} from '../../plugins/cb-graphs';
...
export class NewBoardComponent implements OnInit {
  ...
  addAfterBlockEditor = (id, checker, category= null) => {
    try {
      ...
      if (checker === 13) {
        ...
        this.AddGraph.AddGraphFunction(uid);
      }
      ...
      `);
          ...
          function getData() {
            ...
            dKeys.forEach((dLabel, index) => {
              ...
              if (index == dKeys.length - 1) {
                ...
                const dSet = { label: dLabel, data: [], fill: false, backgroundColor: [], borderColor: [] };
        ...
        //  hide the graph upload dialogue
  ...
  addGraph = () => {
    ...
    this.addAfterBlockEditor('main-box', 13);
  }
  // Adding paragraph
  cbToolboxParaTag = () => {
